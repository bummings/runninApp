...
public class RunInput {
    public Double handle(Scanner scanner) {
        ...
        // Utilizing the LocalDateTime library to
        // generate timestamp,and running it thru
        // the DateTimeFormatter library to shape
        // it more cohesively for the output.txt
